...
while true do
  ...
  lx, ly = Pads.getLeftStick()
    ...
    if Pads.check(pad, PAD_SELECT) then
      ...
      Graphics.drawImage(pad_select, 260.0, 190.0, Color.new(255, 255, 255, 60))
    end

    if Pads.check(pad, PAD_START) then
      Graphics.drawImage(start, 380.0, 190.0)
    else
      Graphics.drawImage(start, 380.0, 190.0, Color.new(255, 255, 255, 60))
    end
    ...
    if Pads.check(pad, PAD_UP) then
      ...
      Graphics.drawImage(up, 120.0, 155.0, Color.new(255, 255, 255, 60))
    end
    ...
    if Pads.check(pad, PAD_DOWN) then
      ...
      Graphics.drawImage(down, 120.0, 225.0, Color.new(255, 255, 255, 60))
    end
    ...
    if Pads.check(pad, PAD_LEFT) then
      ...
      Graphics.drawImage(left, 85.0, 190.0, Color.new(255, 255, 255, 60))
    end
    ...
    if Pads.check(pad, PAD_RIGHT) then
      ...
      Graphics.drawImage(right, 155.0, 190.0, Color.new(255, 255, 255, 60))
    end
    ...
    if Pads.check(pad, PAD_TRIANGLE) then
      ...
      Graphics.drawImage(triangle, 520.0, 155.0, Color.new(255, 255, 255, 60))
    end
   ...
   if Pads.check(pad, PAD_CROSS) then
     ...
     Graphics.drawImage(cross, 520.0, 225.0, Color.new(255, 255, 255, 60))
   end
   ...
   if Pads.check(pad, PAD_SQUARE) then
     ...
     Graphics.drawImage(square, 485.0, 190.0, Color.new(255, 255, 255, 60))
   end
   ...
   if Pads.check(pad, PAD_CIRCLE) then
     ...
     Graphics.drawImage(circle, 555.0, 190.0, Color.new(255, 255, 255, 60))
   end
  ...
  if Pads.check(pad, PAD_L1) then
    ...
    Graphics.drawImage(l1, 102.0, 100.0, Color.new(255, 255, 255, 60))
  end
  ...
  if Pads.check(pad, PAD_L2) then
    ...
    Graphics.drawImage(l2, 137.0, 100.0, Color.new(255, 255, 255, 60))
  end
  ...
  if Pads.check(pad, PAD_R1) then
    ...
    Graphics.drawImage(r1, 502.0, 100.0, Color.new(255, 255, 255, 60))
  end
  ...
  if Pads.check(pad, PAD_R2) then
    ...
    Graphics.drawImage(r2, 537.0, 100.0, Color.new(255, 255, 255, 60))
  end

  Graphics.drawRect(220.0, 280.0, 75, 75, Color.new(255, 255, 255, 32))
  Graphics.drawRect(380.0, 280.0, 75, 75, Color.new(255, 255, 255, 32))
  ...
  if Pads.check(pad, PAD_L3) then
    ...
    Graphics.drawImage(l3, 242.0, 300.0, Color.new(255, 255, 255, 60))
  end

  if Pads.check(pad, PAD_R3) then
    Graphics.drawImage(r3, 402.0, 300.0)
  else
    Graphics.drawImage(r3, 402.0, 300.0, Color.new(255, 255, 255, 60))
  end
